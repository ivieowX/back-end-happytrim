...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO exercise_easy (name, calorie, exercise_image, video_link, details, date) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        $title = "กิจกรรมออกกำลังกายระดับง่ายใหม่";
        $message = "มีการเพิ่มกิจกรรมออกกำลังกายระดับง่ายใหม่: $name";
