...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO exercise_hard (name, calorie, exercise_image, video_link, details, date) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        $title = "กิจกรรมออกกำลังกายระดับยากใหม่";
        $message = "มีการเพิ่มกิจกรรมออกกำลังกายระดับยากใหม่: $name";
